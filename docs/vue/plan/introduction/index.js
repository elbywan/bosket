...
export default {
    ...
    content: h =>
        <div>
            <p>
                This page covers the <em class="highlight"><a href="https://vuejs.org" target="_blank" rel="noopener noreferrer">Vue.js</a></em> implementation of the <em><a href="..">Bosket library</a></em>.<br/>
