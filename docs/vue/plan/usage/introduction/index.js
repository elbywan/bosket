...
export default {
    ...
    content:
        <p>
            This page covers the <em className="highlight"><a href="https://facebook.github.io/react/" target="_blank" rel="noopener noreferrer">React</a></em> implementation of the <em><a href="..">Bosket library</a></em>.<br/>
            ...
            <br/>
            If you are interested by some eye candy, you can have a look <em><a href="#TreeView#Demo">at</a></em> <em><a href="#Presets#ExplorerView#Demo">some</a></em> <em><a href="#Presets#MenuView#Demo">usage</a></em> <em><a href="#Presets#FlatView#Demo">examples</a></em>.<br/>
            The source code is included alongside.
        </p>
}
