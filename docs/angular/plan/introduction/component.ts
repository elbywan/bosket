...
@Component({
    template: `
        <p>
            This page covers the <em class="highlight"><a href="https://angular.io/" target="_blank" rel="noopener noreferrer">Angular</a></em> implementation of the <em><a href="..">Bosket library</a></em>.<br/>
