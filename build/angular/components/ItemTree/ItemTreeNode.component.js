...
var ItemTreeNode = (function () {
    function ItemTreeNode(_cdRef, _componentFactoryResolver) {
        var _this = this;
        this._cdRef = _cdRef;
    ...
    ItemTreeNode.prototype.ngAfterViewInit = function () {
        var _this = this;
        if (this.model instanceof Array)
            this.model.forEach(function (i) { return _this.ancestorsMap.set(i, _this.ancestors.concat([i])); });
    };
    ItemTreeNode.prototype.ngAfterViewChecked = function () {
        this.injectItems();
    };
    Object.defineProperty(ItemTreeNode.prototype, "rootdrop", {
        get: function () { return this.dragndrop.draggable && !this.depth; },
        enumerable: true,
        configurable: true
    });
    ItemTreeNode.prototype.injectItems = function () {
        var _this = this;
...
ItemTreeNode.ctorParameters = function () { return [
    { type: ChangeDetectorRef, },
    { type: ComponentFactoryResolver, },
]; };
ItemTreeNode.propDecorators = {
    'model': [{ type: Input },],
    'category': [{ type: Input },],
...
//# sourceMappingURL=ItemTreeNode.component.js.map